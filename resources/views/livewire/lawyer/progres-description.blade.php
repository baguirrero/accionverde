<div>
    <article class="card" x-data="{open: false}">
        <div class="card-body bg-gray-100">
            <header>
                <h1 x-on:click="open = !open" class="cursor-pointer">Descripcion de la Tarea</h1>
            </header>
            ...
            <div x-show="open">
                ...
                @else
                    <div>
                        <textarea wire:model="name" class="form-input w-full" placeholder="Agregar una descripcion"></textarea>
